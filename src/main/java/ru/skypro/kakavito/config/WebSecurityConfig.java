...
import ru.skypro.kakavito.service.impl.CustomUserDetailsServiceImpl;
...
public class WebSecurityConfig {
    ...
    @Bean
    public CustomUserDetailsServiceImpl userDetailsService(PasswordEncoder passwordEncoder) {
        return new CustomUserDetailsServiceImpl(userRepo, passwordEncoder);
    }
